...
if (isset($_POST['ajukan'])) {
    if ($cek_pending) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $error = "Gagal mengirim pengajuan: " . mysqli_error($conn);
        }
    }
}
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .page-body{padding:28px;display:grid;grid-template-columns:420px 1fr;gap:24px;align-items:start;}
        ...
        .btn-primary{background:#1a5276;color:white;border:none;border-radius:8px;padding:12px;width:100%;font-size:14px;font-weight:600;cursor:pointer;transition:0.2s;}
...
<div style="margin-left:220px;">
    ...
    <div class="page-body">
        ...
        <div class="card">
            ...
            <table>
                <thead>
                    <tr><th>Tanggal</th><th>Dari → Ke</th><th>Status</th><th>Catatan Admin</th></tr>
                </thead>
                <tbody>
                <?php
                $ada = false;
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-<?= $r['status'] ?>">
                            <?= $r['status']==='menunggu'?'⏳ Menunggu':($r['status']==='disetujui'?'✅ Disetujui':'❌ Ditolak') ?>
                        </span>
                        <?php if($r['status']==='disetujui'): ?>
                        <div style="font-size:11px;color:#27ae60;margin-top:4px">Naik ke Sem <?= $r['semester_tujuan'] ?></div>
                        <?php endif; ?>
                    </td>
                ...
                <?php endwhile; ?>
                <?php if(!$ada): ?>
                <tr><td colspan="4" style="text-align:center;color:#aaa;padding:40px">Belum ada riwayat pengajuan</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
